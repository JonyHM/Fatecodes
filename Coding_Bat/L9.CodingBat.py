...
# e o primeiro elemento e igual ao ultimo
...
# iguais ou os dois ultimos sao iguais
...
# os elementos sao o maior das duas pontas
# obs.: nao e o maior de todos, mas entre as duas pontas
...
# eu e par sao as notas das suas roupas de 0 a 10
# quanto maior a nota mais chique voces estao vestidos
# o resultado e se voces conseguiram uma mesa no restaurante:
# 0=não 1=talvez e 2=sim
# se a nota da roupa de um dos dois for menor ou igual a 2
# voces nao terao direito a uma mesa (0)
# se as notas sao maiores, entao caso um dos dois esteja
# bem chique (nota >= 8) entao a resposta e sim (2)
# caso contrario a resposta e talvez (1)
# date_fashion(5, 10) -> 2
# date_fashion(5, 2) -> 0
# date_fashion(5, 5) -> 1
...
# graus Fahreneit (sao estrangeiros e o termometro e diferente rs)
# caso seja verao, então a temperatura superior é 100 no lugar de 90
...
# velocidade entre 61 e 80 multa media
# velocidade maior que 81 multa grave (cidade do interior)
# caso seja seu aniversario a velocidade pode ser 5 km/h maior em todos os casos
...
# o retorno e uma string que diz quando o despertador tocara
# dias da semana '07:00'
# finais de semana '10:00'
# a menos que você esteja de ferias, neste caso:
