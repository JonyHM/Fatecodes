...
# A. near_ten
# Seja um n nao negativo, retorna True se o numero esta a distancia de
# pelo menos dois de um multiplo de dez. Use a funcao resto da divisao.
# near_ten(12) -> True
# near_ten(17) -> False
# near_ten(19) -> True
def near_ten(n):
...
# Se aparecer um 13 ele nao conta e todos os da sua direita tambem
# lucky_sum(1, 2, 3) -> 6
# lucky_sum(1, 2, 13) -> 3
# lucky_sum(1, 13, 3) -> 1
def lucky_sum(a, b, c):
...
# assim 'coxe' ou 'coze' tambem sao contadas como 'code'
...
# 13 da azar, voce devera ignorar o 13 e todos os numeros a sua direita
# sum13([1, 2, 2, 1]) -> 6
# sum13([1, 1]) -> 2
# sum13([1, 2, 2, 1, 13]) -> 6
# sum13([13, 1, 2, 3, 4]) -> 0
...
# e possivel uma solucao sem usar for ou while
